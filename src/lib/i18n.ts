...
export const CHECKOUT = {
  bg: {
    ...
    daySat: "Събота, 07.11",
    daySun: "Неделя, 08.11",
    dayNote: "CORE е за един ден по избор - денят се вписва на билета.",
    quantity: "Брой",
    name: "Име и фамилия",
    email: "Имейл",
  ...
  en: {
    ...
    soldOut: "sold out",
    day: "Which day",
    daySat: "Saturday, 7 Nov",
    daySun: "Sunday, 8 Nov",
    dayNote: "CORE admits one day of your choice - the day is printed on the ticket.",
    quantity: "Quantity",
    name: "Full name",
    email: "Email",
