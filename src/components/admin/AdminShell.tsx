...
const I = {
  plane: <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M10 2.4c1.1 0 1.9 1.3 1.9 3v3.4l6.1 4.3v2.3l-6.1-2.2v4.4l-1.9 1.8-1.9-1.8v-4.4L2 15.4v-2.3l6.1-4.3V5.4c0-1.7.8-3 1.9-3z"/></svg>,
