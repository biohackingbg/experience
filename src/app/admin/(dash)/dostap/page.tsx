      ...
      <div className="mx-auto w-full max-w-4xl">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h1 className="mt-2 font-display text-3xl font-[900] uppercase tracking-tight text-bh-ink">Достъп</h1>
          </div>
          <HomeLink />
        </div>
        ...
        <section className="mt-6 rounded-3xl border border-bh-ink/15 px-6 py-5">
          ...
          <ul className="mt-3 flex flex-col gap-2 text-sm leading-relaxed text-bh-ink/70">
            ...
            <li>Dashboard, Финанси, Фактури, Записвания и Писма показват имена и имейли на купувачи. Достъп до тях е за екипа, не за партньорски фирми.</li>
          </ul>
        </section>
      </div>
    </div>
